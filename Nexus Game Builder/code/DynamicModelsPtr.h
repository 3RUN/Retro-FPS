#ifndef _DYNAMICMODELSPTR_H_
#define _DYNAMICMODELSPTR_H_
 ...
 */
#define DMDL_MAX_INDEXCOUNT 65536
...
typedef struct
{
	...
	int vertexCount;
	/**
	 * \brief Maximum of vertices the model is able to store.
	 */
	int vertexMax;
	...
	int faceCount;
	/**
	 * \brief Maximum of faces the model is able to store.
	 */
	int faceMax;
...
/**
 * \brief  Creates a new dynamic model of a given size
 * \param  vertexCount Max vertex.
 * \param  faceCount   Max faces.
 * \return The newly created dynamic model.
 */
...
/**
 * \brief Merges the second model into the first.
 * \param model    The model where the mesh should be added.
 * \param mesh     The mesh to be added.
 */
void dmdl_merge ( DynamicModel *model, DynamicModel *source );

/**
 * \brief Merges the second model into the first.
 * \param model    The model where the mesh should be added.
 * \param source   The mesh to be added.
 * \param offset   The offset for each vertex in the mesh.
 */
void dmdl_merge ( DynamicModel *model, DynamicModel *source, VECTOR *offset);
 ...
 * \param rotation The rotation for each vertex to be applied before moving.
 */
void dmdl_merge ( DynamicModel *model, DynamicModel *source, VECTOR *offset, ANGLE *rotation );
 ...
 * \param scale    The scale for each vertex to be applied before rotating.
 */
void dmdl_merge ( DynamicModel *model, DynamicModel *source, VECTOR *offset, ANGLE *rotation, VECTOR *scale );
...
void dmdl_empty ( DynamicModel *model );
