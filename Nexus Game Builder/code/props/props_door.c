...
void door_update(ENTITY *ent)
{
    ...
    case (PROPS_CLOSE_STATE):
    {
        ...
        if (vec_dist(&ent->x, &props->origin) > 0.5)
        {
            ...
            c_ignore(SWITCH_ITEM_GROUP, PROJECTILE_GROUP, SHOOT_THROUGH_GROUP, OBSTACLE_GROUP, WALL_GROUP, 0);
...
action props_door()
{
	if(nxsCmData[cm_id].doorFlag1 == 1){set(my, RED_KEY);}
	if(nxsCmData[cm_id].doorFlag2 == 1){set(my, YELLOW_KEY);}
	if(nxsCmData[cm_id].doorFlag3 == 1){set(my, BLUE_KEY);}
	if(nxsCmData[cm_id].doorFlag4 == 1){}
	if(nxsCmData[cm_id].doorFlag5 == 1){}
	...
	if(nxsCmData[cm_id_B].doorFlag1 == 1){set(my, RED_KEY);}
	if(nxsCmData[cm_id_B].doorFlag2 == 1){set(my, YELLOW_KEY);}
	if(nxsCmData[cm_id_B].doorFlag3 == 1){set(my, BLUE_KEY);}
	if(nxsCmData[cm_id_B].doorFlag4 == 1){}
	if(nxsCmData[cm_id_B].doorFlag5 == 1){}
	...
	if(nxsCmData[cm_id_C].doorFlag1 == 1){set(my, RED_KEY);}
	if(nxsCmData[cm_id_C].doorFlag2 == 1){set(my, YELLOW_KEY);}
	if(nxsCmData[cm_id_C].doorFlag3 == 1){set(my, BLUE_KEY);}
	if(nxsCmData[cm_id_C].doorFlag4 == 1){}
	if(nxsCmData[cm_id_C].doorFlag5 == 1){}
	...
	if(nxs_layer == 1){my->pan = tiles[cm_XY[0]][cm_XY[1]].rotation;}
	if(nxs_layer == 2){my->pan = tilesB[cm_XY[0]][cm_XY[1]].rotation;}
	if(nxs_layer == 3){my->pan = tilesC[cm_XY[0]][cm_XY[1]].rotation;}
