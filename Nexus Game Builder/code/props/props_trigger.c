...
{
	if(nxs_layer == 1){my->skill1 = tiles[cm_XY[0]][cm_XY[1]].triggerID;}
	if(nxs_layer == 2){my->skill1 = tilesB[cm_XY[0]][cm_XY[1]].triggerID;}
	if(nxs_layer == 3){my->skill1 = tilesC[cm_XY[0]][cm_XY[1]].triggerID;}
